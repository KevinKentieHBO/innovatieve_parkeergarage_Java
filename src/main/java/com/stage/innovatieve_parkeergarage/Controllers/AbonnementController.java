...
public class AbonnementController {
    ...
    @GetMapping("/abonnement/get/{autoid}")
    public String GetAllAbonnementenAuto(@PathVariable int autoid) throws SQLException, ClassNotFoundException {
        JsonArray abonnementenJsonArray = new JsonArray();
        ArrayList<Abonnement> abonnementArrayList = abonnementDAO.getAbonnementenAutoId(autoid);
